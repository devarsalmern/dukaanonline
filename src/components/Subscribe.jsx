...
const Subscribe = () => {
  ...
  return (
    <div className="bg-white text-black dark:bg-gray-800 dark:text-white">
      <div className="flex flex-col lg:flex-row items-center p-4 md:p-5 lg:p-6 bg-gray-100 rounded-lg shadow-lg mt-8 mx-4 md:mx-auto lg:mx-auto max-w-screen-md lg:max-w-screen-lg dark:bg-gray-700 dark:text-white">
        {/* Image Section */}
        ...
        <div className="flex-1 lg:ml-6 text-center lg:text-left">
          {subscribed ? (
            <div>
              ...
              <p className="text-sm md:text-base lg:text-lg text-gray-800 dark:bg-gray-800 dark:text-white">
